...
checkBrowsers(paths.appPath)
  ...
  .then(port => {
    ...
    const config = require('../config/parcel.config.dev');

    function start() {
      const file = paths.appHtml; // Pass an absolute path to the entrypoint here
      const options = { ...config }; // See options section of api docs, for the possibilities
      ...
      app.listen(port, err => {
        ...
        console.log('Bundling success! Your app is live at ', urls.localUrlForBrowser);
        console.log(chalk.cyan('Starting the development server...\n'));
        openBrowser(urls.localUrlForBrowser);
      });
    }
